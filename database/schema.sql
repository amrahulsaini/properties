...
CREATE TABLE IF NOT EXISTS advance_bookings (
  ...
  KEY idx_bookings_seller (seller_name),
...
CREATE TABLE IF NOT EXISTS development_entries (
  id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  site_id BIGINT UNSIGNED NOT NULL,
  jcb_number VARCHAR(120) NULL,
  tractor_number VARCHAR(120) NULL,
  damper_number VARCHAR(120) NULL,
  owner_name VARCHAR(180) NULL,
  driver_name VARCHAR(180) NULL,
  mobile_number VARCHAR(32) NULL,
  rent_type VARCHAR(32) NULL,
  amount_mode VARCHAR(32) NULL,
  start_date DATE NULL,
  end_date DATE NULL,
  ...
  rate_per_trip DECIMAL(14,2) NOT NULL DEFAULT 0,
  advance_diesel DECIMAL(14,2) NOT NULL DEFAULT 0,
  diesel_given DECIMAL(14,2) NOT NULL DEFAULT 0,
  diesel_cost DECIMAL(14,2) NOT NULL DEFAULT 0,
  advance_paid DECIMAL(14,2) NOT NULL DEFAULT 0,
  remaining_amount DECIMAL(14,2) NOT NULL DEFAULT 0,
  payment_status VARCHAR(32) NOT NULL DEFAULT 'pending',
  work_type VARCHAR(120) NULL,
  construction_material VARCHAR(180) NULL,
  work_location VARCHAR(255) NULL,
  gps_location VARCHAR(255) NULL,
  loading_point VARCHAR(255) NULL,
  unloading_point VARCHAR(255) NULL,
  work_description TEXT NULL,
  working_photo_url VARCHAR(500) NULL,
  ...
  KEY idx_development_entries_category (category),
  KEY idx_development_entries_payment (payment_status),
...
CREATE TABLE IF NOT EXISTS document_folders (
  ...
  project_id BIGINT UNSIGNED NULL,
  folder_code VARCHAR(64) NULL,
  folder_label VARCHAR(255) NULL,
  plot_number VARCHAR(120) NULL,
  buyer_name VARCHAR(180) NULL,
  buyer_mobile_number VARCHAR(32) NULL,
  buyer_aadhaar_number VARCHAR(32) NULL,
  buyer_pan_number VARCHAR(32) NULL,
  seller_name VARCHAR(180) NULL,
  seller_mobile_number VARCHAR(32) NULL,
  seller_aadhaar_number VARCHAR(32) NULL,
  seller_pan_number VARCHAR(32) NULL,
  witness_1_name VARCHAR(180) NULL,
  witness_1_aadhaar_number VARCHAR(32) NULL,
  witness_2_name VARCHAR(180) NULL,
  witness_2_aadhaar_number VARCHAR(32) NULL,
  identifier_name VARCHAR(180) NULL,
  identifier_mobile_number VARCHAR(32) NULL,
  identifier_aadhaar_number VARCHAR(32) NULL,
  ...
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  UNIQUE KEY ux_document_folders_code (folder_code),
  KEY idx_document_folders_project (project_id),
  KEY idx_document_folders_plot (plot_number),
  KEY idx_document_folders_buyer_mobile (buyer_mobile_number),
  KEY idx_document_folders_buyer_aadhaar (buyer_aadhaar_number),
...
CREATE TABLE IF NOT EXISTS documents (
  ...
  KEY idx_documents_section (section),
